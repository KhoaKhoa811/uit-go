...
const (
	...
	TripService_EstimateTripFare_FullMethodName = "/trip.TripService/EstimateTripFare"
)
...
type TripServiceClient interface {
	...
	EstimateTripFare(ctx context.Context, in *EstimateTripFareRequest, opts ...grpc.CallOption) (*EstimateTripFareResponse, error)
}
...
func (c *tripServiceClient) EstimateTripFare(ctx context.Context, in *EstimateTripFareRequest, opts ...grpc.CallOption) (*EstimateTripFareResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EstimateTripFareResponse)
	err := c.cc.Invoke(ctx, TripService_EstimateTripFare_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TripServiceServer interface {
	...
	EstimateTripFare(context.Context, *EstimateTripFareRequest) (*EstimateTripFareResponse, error)
...
func (UnimplementedTripServiceServer) EstimateTripFare(context.Context, *EstimateTripFareRequest) (*EstimateTripFareResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EstimateTripFare not implemented")
}
...
func _TripService_EstimateTripFare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EstimateTripFareRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TripServiceServer).EstimateTripFare(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TripService_EstimateTripFare_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TripServiceServer).EstimateTripFare(ctx, req.(*EstimateTripFareRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TripService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EstimateTripFare",
			Handler:    _TripService_EstimateTripFare_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/trip/pb/trip.proto",
}
